...
來源：[`amin-vault/ARCHITECTURE.md`](https://github.com/ken12121122-dotcom/ken12121122-dotcom.github.io/blob/claude/llm-tokenizer-impl-6iod8c/amin-vault/ARCHITECTURE.md)、[`AGENTS.md`](https://github.com/ken12121122-dotcom/ken12121122-dotcom.github.io/blob/claude/llm-tokenizer-impl-6iod8c/AGENTS.md)

## 已知限制（Bridge 16 標註，2026-07-19）

- Android WebView 內 Web Gamepad API 可能是空的（原生橋接才是輸入真相來源，見 [`pages/controller-input.md`](./controller-input.md)）。
...
`native-release-manifest.json`（見 [`pages/release-process.md`](./release-process.md) 的版本矛盾段落）顯示 Bridge 23 新增了「Amin Control API v1」，包含語音、REST、WebSocket、Broadcast/Explicit Intent、Deep Link、Tasker/MacroDroid/Automate、ADB 控制等入口，統一進 `AminInputGateway`。這聽起來跟上面「共用 Action Core」「Controller Lab」的方向有關，但：
