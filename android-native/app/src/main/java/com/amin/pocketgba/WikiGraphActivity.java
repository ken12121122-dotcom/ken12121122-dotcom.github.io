...
public final class WikiGraphActivity extends Activity {
    ...
    /** Graph taps enter Inspector; Inspector's Open Node action performs the actual route navigation. */
